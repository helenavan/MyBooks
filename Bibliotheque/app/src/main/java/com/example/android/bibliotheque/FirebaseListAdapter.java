package com.example.android.bibliotheque;
...
import com.example.android.bibliotheque.Model.BookModel;
...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
     ...
     */
    public FirebaseListAdapter(Query mRef, Class<BookModel> mModelClass, int mLayout, Activity activity) {
        this.mRef = mRef;
        ...
        mListener = this.mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                BookModel model = dataSnapshot.getValue(FirebaseListAdapter.this.mModelClass);
